            ...
            <section class="upload-form__background">
                ...
                <fieldset>
                    <div>
                        ...
                        <label for="bg"> <img border="2" src="done/bg.png" width="90" height="90"> Old background
                        </label>
                    </div>
                    <div>
                        <input type="radio" id="bg3" name="background" value="bg3">
                        <label for="bg3"> <img border="2" src="done/bg3.png" width="90" height="90"> New background
                        </label>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <label for="bg5"> <img border="2" src="done/bg4.png" width="90" height="90"> Psawhns background
                            with

...
function taskText($carts, $cargo, $from, $to)
{
    $rewardMultiplier = 0;
    switch($cargo){
        case 'logs' : $rewardMultiplier = 60; break;
        case 'steel pipes' : $rewardMultiplier = 180; break;
        case 'lumber' : $rewardMultiplier = 72; break;
        case 'raw iron' : $rewardMultiplier = 54; break;
        case 'rails' : $rewardMultiplier = 180; break;
        case 'beams' : $rewardMultiplier = 36; break;
        case 'cordwood' : $rewardMultiplier = 80; break;
        case 'oil barrels' : $rewardMultiplier = 1840; break;
        case 'coal' : $rewardMultiplier = 150; break;
        case 'iron ore' : $rewardMultiplier = 140; break;
        case 'crude oil' : $rewardMultiplier = 192; break;
        case 'tools' : $rewardMultiplier = 480; break;
    }

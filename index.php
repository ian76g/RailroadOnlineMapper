...
<hr style="clear:both">
made by ian76g#6577 on discord - used by
people <?php file_put_contents('counter', $counter = file_get_contents('counter') + 1);
echo $counter ?> times<br>
<div style="font-weight: bold">if you want to help to cover hosting costs - maybe share a buck on paypal@pordi.de -
    thx.
</div>

...
thingy(angle,x,y){x+=Math.cos(this.deg2rad(angle))*2;y+=Math.sin(this.deg2rad(angle))*2;return[x,y];}
...
const path=document.createElementNS(this.svgNS,"path");let fillColor=cartOptions[vehicle['Type']][1];fillColor=cookies.get('ce_'+vehicle['Type']);path.setAttribute("class",'ce_'+vehicle['Type']);if(typeof vehicle['Freight']!=='undefined'&&typeof vehicle['Freight']['Amount']!=='undefined'&&vehicle['Freight']['Amount']>0&&cartOptions[vehicle['Type']][2]!==undefined){path.setAttribute("class",'cf_'+vehicle['Type']);fillColor=cartOptions[vehicle['Type']][2];fillColor=cookies.get('cf_'+vehicle['Type']);}

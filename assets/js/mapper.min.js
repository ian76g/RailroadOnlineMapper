...
playerEditNearValue.appendChild(playerEditNearTextNode);playerEditInfoRow.appendChild(playerEditNearValue);let playerEditDeleteValue=document.createElement("td");let playerEditDeleteInput=document.createElement("input");playerEditDeleteInput.type="checkbox"
...
return name;}
_dist(coordsIn,coords2In,flat=false){const coords=JSON.parse(JSON.stringify(coordsIn));const coords2=JSON.parse(JSON.stringify(coords2In));if(coords2===undefined){return 9999999999;}
let distance;if('X'in coords){if('X'in coords2){if(flat===true){coords['Z']=coords2['Z']=0;}
